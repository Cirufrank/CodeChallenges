...
function bubblesortOnce(a) {
    const sortedArray = a.slice();
    let pointer1 = 0;
    let pointer2 = 1;
    while(pointer2 < sortedArray.length) {
      if (sortedArray[pointer1] > sortedArray[pointer2]) [sortedArray[pointer1], sortedArray[pointer2]] = [sortedArray[pointer2], sortedArray[pointer1]]
      pointer1 += 1;
      pointer2 += 1;
    }
    return sortedArray;
