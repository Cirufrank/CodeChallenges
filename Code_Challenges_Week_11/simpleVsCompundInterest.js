...
function interest(P,r,n) {
    return [Math.round((1 + r * n) * P), Math.round(P * Math.pow(1 + r, n))];
  }
...
describe("Tests", () => {
  it("test", () => {
//interest(Principal, interest rate, number of time periods) =
// [total with simple interest, total with compound interest]

Test.assertDeepEquals(interest(100,0.1,1), [110,110]);
Test.assertDeepEquals(interest(100,0.1,2), [120,121]);
Test.assertDeepEquals(interest(100,0.1,10), [200,259]);
  });
});
