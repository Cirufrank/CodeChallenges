...
//     squares.forEach(num => {
//       let totalDigitsOfD = String(num).split("").filter(digit => Number(digit) === d).length
//       result += totalDigitsOfD;
//     })
//   return result
    return squares.join("").split("").filter(digit => Number(digit) === d).length
